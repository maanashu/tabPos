...
const ReturnShipment = ({ orderData, onPressShop }) => {
  ...
  const returnStatusView = (heading) => (
    <View style={styles.statusMainView}>
      ...
      <View>
        {heading === 'Return to Shop' && orderData?.is_delivery_dispute ? (
        ...
        <>
          <View style={styles.headerMainView}>
            <View>
              ...
              <Text style={styles.currentStatusText}>{strings.orderStatus.cancelled}</Text>
            </View>
...
export default memo(ReturnShipment);
