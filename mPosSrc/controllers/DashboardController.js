...
export class DashboardController {
  ...
  //     return new Promise((resolve, reject) => {
  //       const endpoint =
  //         ApiOrderInventory.getTotalSale + `?seller_id=${sellerID}&filter=today`;
  //       HttpClient.get(endpoint)
  //         .then((response) => {
  //           resolve(response);
  //         })
  ...
  //     return new Promise((resolve, reject) => {
  //       const endpoint =
  //         ApiOrderInventory.onLineOrders + `?seller_id=${sellerID}`;
  //       HttpClient.get(endpoint)
  //         .then((response) => {
  //           resolve(response);
  //         })
  ...
  //     return new Promise((resolve, reject) => {
  //       const endpoint =
  //         ApiOrderInventory.pendingOrders + `?seller_id=${sellerID}`;
  //       HttpClient.get(endpoint)
  //         .then((response) => {
  //           resolve(response);
  //         })
  ...
  //         return;
  //       }
  //       const endpoint = ApiOrderInventory.return;
  ...
  static async scanBarCode(data) {
    return new Promise((resolve, reject) => {
      const endpoint = ApiOrderInventory.scanbarcode;
      const body = {
        barcode: data,
      };
      HttpClient.post(endpoint, body)
