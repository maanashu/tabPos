  ...
  const changeView = () => {
    if (printScreen){
      ...
      <View style={[styles.headerMainView, { paddingVertical: SH(0) }]}>
        <View style={[styles.orderDetailView, styles.orderDetailView2, {borderWidth:1}]}>
            <Spacer space={SH(20)} />
           ...
           <FlatList
            ...
            <View style={[styles.bottomSheet, styles.bottomSheet2]}>
              <View style={{borderWidth:1, width:SH(385), alignSelf:'flex-end'}}/>
          ...
          <Spacer space={SH(20)} />
              <Text style={styles.orderReviewText}>{strings.deliveryOrders.selectShip}</Text>
          <Spacer space={SH(20)} />
                      ...
                      <View style={{flexDirection:'row', alignItems:'center'}}>
                       ...
                       <Image source={ups2} style={styles.ups2}/>
                           <View style={{paddingHorizontal:moderateScale(5)}}>
                             <Text style={styles.shipingRate}>{strings.shipingOrder.priorityMalling}</Text>
                             <Text>{strings.shipingOrder.dayShiping}</Text>
                           </View>
                       </View>
                      </View>
                      <Text style={styles.shipingRate}>{strings.shipingOrder.shipingRate}</Text>
                </View>
          </View>
          <Spacer space={SH(20)} />
          <View style={styles.selectShipingCon}>
          ...
          <TouchableOpacity style={styles.printButtonCon}>
              <Text style={styles.printText}>{strings.shipingOrder.printText}</Text>
          </TouchableOpacity>
      ...
      <View style={[styles.headerMainView, { paddingVertical: SH(0),}]}>
         ...
         <View style={[styles.orderNumberLeftView]}>
           ...
           {/* <View style={styles.reviewHeadingView}>{orderStatusText()}</View> */}
            <Text style={styles.orderOfReview}>{strings.shipingOrder.orderOfReview}</Text>
            <Spacer space={SH(10)}/>
           <FlatList
          ...
          <FlatList
           ...
           <View style={styles.bottomSheet}>
             ...
             <View style={styles.rowView}>
              ...
              <View style={{borderWidth:1, borderStyle:'dashed', width:SH(380), alignSelf:'flex-end', borderColor:COLORS.row_grey,marginVertical:verticalScale(2)}}/>
             <View style={styles.rowView}>
               <Text style={[styles.subTotal, { color: COLORS.darkGray }]}>{strings.deliveryOrders.tax}</Text>
               <Text style={styles.discountValue}>{strings.deliveryOrders.subTotalValue}</Text>
             </View>
