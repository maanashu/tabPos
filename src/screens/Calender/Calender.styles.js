...
export const styles = StyleSheet.create({
  ...
  rescheduleSelectTimetitle: { fontFamily: Fonts.Regular, fontSize: ms(7) },
  ...
  rescheduleSubContainer: { margin: ms(10) },
  cancelAppointmentText: { fontFamily: Fonts.SemiBold, color: COLORS.white, fontSize: ms(8) },
  ...
  rescheduleBtnText: { fontFamily: Fonts.SemiBold, fontSize: ms(8), color: COLORS.white },
  rescheduleBtn: {
    alignItems: 'center',
    justifyContent: 'center',
    height: ms(30),
