...
import { View, Text, Image, TouchableOpacity, FlatList, ScrollView, Platform } from 'react-native';
  ...
  return (
    <Modal
      ...
      style={{
        ...
        top: Platform.OS == 'ios' ? height * 0.1 : height * 0.05,
      }}
    >
      <View style={styles.eventDetailModalContainer}>
        ...
        {/*  */}
        {customerDetails && (
          <View style={[styles.customerDetailContainerBorder, { marginTop: ms(5) }]}>
            <View style={styles.rowAlignedJustified}>
