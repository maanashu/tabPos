...
export function POSUsers({ navigation }) {
  ...
  return (
    <ScreenWrapper>
      {!twoFactorEnabled?<View style={styles.container}>
    ...
    {sixDigit?
      ...
      <View style={[styles.flexRowSix, styles.flexWidthSix]}>
        ...
        <TouchableOpacity onPress={() =>{ dispatch(logoutFunction()), setSixDigit(false)}}>
            ...
            <View style={styles.modalHeaderCon}>
              <View style={styles.flexRowSix}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => { dispatch(logoutFunction()),setGoogleAuthScan(false)}}
                >
          ...
          <View style={styles.modalMainView}>
            <View style={styles.modalHeaderCon}>
              <View style={styles.flexRowSix}>
                ...
                <TouchableOpacity
                  style={styles.crossButtonCon}
                  onPress={() => { dispatch(logoutFunction()),setTwoStepModal(false)}}
                >
                  <Image source={crossButton} style={styles.crossButton} />
                </TouchableOpacity>
              </View>
